...
reg = re.compile("(Niko | Nikolai) Stein") #Space matters, so this searches for "Niko  Stein" because it has two spaces between.
print(reg.match(string))

reg = re.compile("(Niko|Nikolai) Stein")
print(reg.match(string))

#Rest is confusing, he forgot to remove it.
# string = "\."
